...
Wireframes de média fidelidade das telas estão em `Projeto_Locadora/docs/wireframes.html`
(abra no navegador). Versão online compartilhável: ver o link na entrega do Canvas.
